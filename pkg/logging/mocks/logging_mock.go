...
//
//	mockgen -source=pkg/logging/logging.go -destination=pkg/logging/mocks/logging_mock.go -package=mocks
//
...
import (
	...
	logging "github.com/alexGoLyceum/calculator-service/pkg/logging"
